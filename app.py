...
class ThirdScreen(Screen):
    ...
    def next(self):
        if self.next_screen is False:
            self.lbl_sits.start_count_down()
...
class FourthScreen(Screen):
    def __init__(self, **kwargs):
        ...
        pulse = Label(text="Рахуйте пульс!", bold=True, font_size=35, size_hint=(1, .1))
        self.seconds = Timer(txt="Пройшло секунд:", total=60, bold=True, font_size=35, size_hint=(1, .1))
